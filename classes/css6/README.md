...
- É possível **definir um ponto que ficará fixo** (será a origem da transformação)
  ...
  <iframe width="500" height="240" src="//jsfiddle.net/willsallum/jwpxz9vg/1/embedded/result,html,css/" allowfullscreen="allowfullscreen" frameborder="0" class="push-right"></iframe>
