...
- É possível que um elemento interrompa uma flutuação à esquerda (`left`),
  ...
  <iframe width="50%" height="460" src="//jsfiddle.net/fegemo/vxb79m2c/embedded/result,html,css/dark/" allowfullscreen="allowfullscreen" frameborder="0" style="float: left"></iframe>
