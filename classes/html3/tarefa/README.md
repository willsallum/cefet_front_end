...
1. [Baixe as imagens e o ícone](https://github.com/willsallum/cefet_front_end_pirates/archive/master.zip) que serão usados
...
1. **Crie um arquivo `index.html`** na mesma pasta e siga os passos:
   ...
   1. Veja [instruções detalhadas aqui](https://github.com/willsallum/cefet_front_end_pirates/blob/master/README.md)
...
- É possível usar cores com transparência, que deixam
 ...
 - Resultados:
  ...
  <p style="color: rgba(255, 255, 255, 0.4); background-color:red; margin:2px; width=100px;"> branco</p>
  <p style="color: rgba(255, 255, 255, 0.7); background-color:red; margin:2px; width=100px;"> branco</p>
  <p style="color: rgba(255, 255, 255, 1); background-color:red; margin:2px; width=100px;"> branco</p>
  <p style="color: rgba(0, 0, 0, 0.5); background-color:red; margin:2px; width=100px;"> preto</p>
  <p style="color: rgba(0, 0, 255, 0.6); font-style: normal; background-color:red; margin:2px; width=100px;">azul</p>
